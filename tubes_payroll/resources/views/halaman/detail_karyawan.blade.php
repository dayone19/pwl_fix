...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-xl font-black text-slate-900 uppercase  tracking-tighter">Profil Detail teknisi</h1>
    </div>
    ...
    <div class="bg-white rounded-[50px] shadow-sm border border-slate-100 overflow-hidden relative">
        ...
        <div class="px-10 pb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                ...
                <div class="space-y-6">
                    <h3 class="text-[10px] font-black text-orange-600 uppercase tracking-[0.3em]  mb-4 flex items-center gap-2">
                    ...
                    <div class="flex flex-col gap-1 border-l-4 border-slate-100 pl-4">
                        ...
                        <span class="text-sm font-bold text-slate-800 font-mono ">#{{ $p->nip }}</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1 border-l-4 border-slate-100 pl-4">
                        ...
                        <span class="text-sm font-bold text-slate-800 uppercase ">{{ $p->pendidikan }}</span>
                    </div>

                    <div class="flex flex-col gap-1 border-l-4 border-slate-100 pl-4">
                        <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Agama</span>
                        <span class="text-sm font-bold text-slate-800 uppercase ">{{ $p->agama }}</span>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col gap-1 border-l-4 border-slate-100 pl-4">
                        ...
                        <span class="text-sm font-bold text-slate-800 ">{{ $p->nomor_telepon }}</span>
                    </div>

                    <div class="pt-6 flex gap-3">
                        <button class="flex-1 bg-slate-900 text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:bg-orange-600 transition-all ">
                            Cetak Kartu Pegawai
                        </button>
